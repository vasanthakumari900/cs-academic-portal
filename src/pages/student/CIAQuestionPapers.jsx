  ...
  return (
    <PdfFileCard
      file={{
        ...
        subject: paper.subject || "CIA Question Paper",
        year: paper.year ? (typeof paper.year === "number" ? `${paper.year}${paper.year === 1 ? "st" : paper.year === 2 ? "nd" : "rd"} Year` : paper.year) : null,
        semester: paper.semester ? `Sem ${paper.semester}` : null,
