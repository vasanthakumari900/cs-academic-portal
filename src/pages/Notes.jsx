// src/pages/Notes.jsx
// Premium glassmorphism Lecture Notes — year → semester → subject drill-down with unit-based PDF downloads
  ...
  "OPERATING SYSTEM": {
    units: {
      1: {
        ...
        files: [
          { id: "os-u1-1", title: "OS Introduction", fileName: "OS-INTRO.pptx", fileId: "1GixI9_7uxRNzbf5qSe_wf4McmWaylQDS", type: "pptx" },
          { id: "os-u1-2", title: "Session 2 - OS Basics", fileName: "ses-2.pptx", fileId: "1Zny7cAR4GR0YTRr3sIZT-u-FAOIQvQ-d", type: "pptx" },
          { id: "os-u1-3", title: "OS Structures - Unit 1", fileName: "os structures-unit 1.pdf", fileId: "1O8-gnDMSgXurNN6O99N4S26z-UlONUbu", type: "pdf" },
          { id: "os-u1-4", title: "OS Structures", fileName: "OSStructures.ppt", fileId: "1xqoPAFz_xavBAX8RR8nNErwANXnce-3B", type: "ppt" },
          { id: "os-u1-5", title: "Processes", fileName: "os-processes.ppt", fileId: "1MoiwrzKonwOc4MH9wuO_sxKm92coXyYM", type: "ppt" },
          { id: "os-u1-6", title: "Interprocess Communication", fileName: "interprocesscommunication-180721182943.pptx", fileId: "14mf_5YIS0TZB00phmq2kTSN8gT1gpfJY", type: "pptx" },
          { id: "os-u1-7", title: "Threads - Unit 1", fileName: "threads-unit 1.pdf", fileId: "172mi8UGGUnGPAPF7zOeSKEBkqFucF5SM", type: "pdf" },
          { id: "os-u1-8", title: "THREADS", fileName: "THREADS.pptx", fileId: "1uU4O05stk5cg2AVhfQBdC1VifAd_nrgJ", type: "pptx" },
        ],
      },
      2: {
        title: "Unit II",
        ...
        files: [{ id: "os-u2-1", title: "OS Unit 2 - Process Scheduling & Synchronization", fileName: "OS_Unit2.pdf", fileId: "1J8M3d7mVSU4oxkyp6q_Dq-m4tuhdVmLV", type: "pdf" }],
      },
      ...
      4: { title: "Unit IV", subtitle: "Memory Management", syllabus: "MEMORY-MANAGEMENT STRATEGIES: SWAPPING - CONTIGUOUS MEMORY ALLOCATION - SEGMENTATION - PAGING - STRUCTURE OF THE PAGE TABLE. VIRTUAL-MEMORY MANAGEMENT: DEMAND PAGING - PAGE REPLACEMENT - ALLOCATION OF FRAMES - THRASHING", files: [] },
      5: { title: "Unit V", subtitle: "Storage Management", syllabus: "STORAGE MANAGEMENT: FILE SYSTEM - FILE CONCEPT - ACCESS METHODS - DIRECTORY AND DISK STRUCTURE - FILE SHARING - PROTECTION. ALLOCATION METHODS - FREE-SPACE MANAGEMENT - EFFICIENCY AND PERFORMANCE - RECOVERY", files: [] },
    },
  },
  "DATABASE MANAGEMENT SYSTEM": {
    units: {
      1: {
        ...
        files: [{ id: "dbms-u1-1", title: "DBMS Unit 1 - Introduction", fileName: "DBMS_Unit1.pdf", fileId: "1RKBkfvx4_s9HN3kBYUK0fHRh6j451JHr", type: "pdf" }],
      },
      2: { title: "Unit II", subtitle: "Relational Model & Normalization", syllabus: "INTRODUCTION TO RELATIONAL DATABASE MODEL - STRUCTURE OF RELATIONAL MODEL - KEYS - RELATIONAL ALGEBRA - NORMALIZATION", files: [] },
      3: { title: "Unit III", subtitle: "SQL", syllabus: "SQL: INTRODUCTION - DATA RETRIEVAL - SINGLE ROW FUNCTION - GROUP FUNCTION - SET FUNCTION - SUB QUERY - JOINS - DML - TCL - VIEW - SEQUENCE - INDEX", files: [] },
      4: { title: "Unit IV", subtitle: "PL/SQL", syllabus: "PL/SQL: INTRODUCTION - PL/SQL BASIC - CHARACTER SET - PL/SQL STRUCTURE - SQL CURSOR - SUBPROGRAMS - FUNCTIONS - PROCEDURES", files: [] },
      5: { title: "Unit V", subtitle: "Exception Handling & Triggers", syllabus: "EXCEPTION HANDLER - INTRODUCTION - PREDEFINED EXCEPTION - USER DEFINED EXCEPTION - TRIGGERS - IMPLICIT AND EXPLICIT CURSORS - LOOPS IN EXPLICIT CURSOR", files: [] },
    },
  },
  "ENGLISH": {
    units: {
      1: { title: "Unit I", subtitle: "English - Complete Notes", syllabus: "OVERALL FIRST YEAR ENGLISH SYLLABUS", files: [{ id: "eng-u1-1", title: "English - Complete Notes", fileName: "English_Complete_Notes.pdf", fileId: "1izO8tdAjD-E4xeTTRXFHKDMmj6eUvZo4", type: "pdf" }] },
      2: { title: "Unit II", subtitle: "", syllabus: "", files: [] },
      3: { title: "Unit III", subtitle: "", syllabus: "", files: [] },
      4: { title: "Unit IV", subtitle: "", syllabus: "", files: [] },
      5: { title: "Unit V", subtitle: "", syllabus: "", files: [] },
    },
  },
  "ASP.NET": {
    units: {
      1: {
        title: "Unit I", subtitle: "Overview of ASP.NET Framework", syllabus: "OVERVIEW OF ASP.NET FRAMEWORK - PAGE STRUCTURE - COMPILER DIRECTIVES - NAMESPACE",
        files: [
          { id: "u1-1", title: "Overview of ASP.Net Framework", fileName: "Overview of ASP.Net Framework.pdf", fileId: "173-KUv6pOGV8o8ihTckpLwvkvDyKv9nj", type: "pdf" },
          { id: "u1-2", title: "ASP Page Structure", fileName: "ASP page structure.pdf", fileId: "1OcVM4CDJTvGvdT9WfqLHFd1Sz61kEO3a", type: "pdf" },
          { id: "u1-3", title: "Compiler Directives", fileName: "Compiler Directives.pdf", fileId: "14CpNpp7OVns3R6Kj4dWy81Io4FiFVvYi", type: "pdf" },
          { id: "u1-4", title: "NAMESPACE", fileName: "NAMESPACE.pdf", fileId: "1cbb7Mt3m7MKXJkW_Hu_YsR4tWKDJanP3", type: "pdf" },
          { id: "u1-5", title: "Overview of ASP.Net Framework (Notes)", fileName: "Overview of ASP.Net Framework (Notes)", fileId: "1VjVHcuCldGrTi6trGyb5gf4Z81RwpzsmsEqKm4Tajfg", type: "doc" },
        ],
      },
      2: { title: "Unit II", subtitle: "ASP.NET Controls", syllabus: "UNDERSTANDING ASP.NET CONTROL: STANDARD CONTROLS - DISPLAYING INFORMATION - ACCEPTING USER INPUT - SUBMITTING FORM DATA - DISPLAYING IMAGES - HYPER LINK CONTROL", files: [{ id: "u2-1", title: "ASP.NET UNIT - 2", fileName: "ASP.NET UNIT -2.pptx", fileId: "1t4g4ab9d5HdKZGuGxmYpWcAwTkjmoqjm", type: "pptx" }] },
      3: { title: "Unit III", subtitle: "Validation & Rich Controls", syllabus: "OVERVIEW OF VALIDATION CONTROL - REQUIRED FIELD VALIDATOR - RANGE VALIDATOR - COMPARE VALIDATOR - CUSTOM VALIDATOR - VALIDATION SUMMARY - RICH CONTROLS: ADROTATOR, CALENDAR", files: [{ id: "u3-1", title: "Validation Controls", fileName: "Validation Controls.docx", fileId: "1z-1R0gaqaVaSIvgRybN5AiA8ExYGsJfY", type: "docx" }, { id: "u3-2", title: "Calendar Control in ASP.NET", fileName: "Calendar Control in ASP.pdf", fileId: "1DInHlyYjC7OpG7sY1i0l987_uZLjo5iY", type: "pdf" }, { id: "u3-3", title: "Rich Controls", fileName: "RICH CONTROLS.pdf", fileId: "1xE1sIoFOWnkI5D7GRbm0EtgyDHpxwYg0", type: "pdf" }] },
      4: { title: "Unit IV", subtitle: "Data Access in ASP.NET", syllabus: "OVERVIEW OF DATA ACCESS: DATA BOUND CONTROL - DATA SOURCE CONTROL - SQLDATASOURCE - OLEDB CONNECTION - OLEDB COMMAND - OLEDB TRANSACTION - DATA ADAPTER - DATASET", files: [{ id: "u4-1", title: "Data Bound Controls", fileName: "data bound controls.docx", fileId: "1IXY-buceR6cV10jEbMClDXUuveYjVWUo", type: "docx" }, { id: "u4-2", title: "Simple Data Bound Controls", fileName: "Simple Data Bound Controls.pdf", fileId: "1PCHmZ2U3uUV8Ah83Do1vZ2bTk4uBArx7", type: "pdf" }] },
      5: { title: "Unit V", subtitle: "List Controls & State Management", syllabus: "LIST CONTROL: DROPDOWN LIST - RADIOBUTTON LIST - LIST BOX - CHECKBOX LIST - BULLETED LIST - GRID VIEW - REPEATER - DATA LIST - ADO.NET - STATE MANAGEMENT: COOKIES, SESSION, WEB SERVICES", files: [{ id: "u5-1", title: "List Controls", fileName: "Listbox RadiobuttionList CheckboxList BulletedList.pdf", fileId: "1hGMGwEMhCFf1J_RyY3pKNKNAEVXnkwH2", type: "pdf" }, { id: "u5-2", title: "ADO.NET Architecture", fileName: "ADO.NET ARCHITECTURE.pdf", fileId: "12EETP-MtzBDgmT_ybJ0xiTebiksP5In4", type: "pdf" }, { id: "u5-3", title: "Application and Session State", fileName: "Application and Session State.pdf", fileId: "1FnobkINTlyJp4Nbi31oTLAtN6_PtLrUX", type: "pdf" }, { id: "u5-4", title: "Cookies", fileName: "COOKIES.pdf", fileId: "1Lw-RzMw2vLCAbYNxR7HzcfYs_Wt102Ob", type: "pdf" }, { id: "u5-5", title: "Web Service", fileName: "WEB SERVICE.pdf", fileId: "1lbt5Eqo79yie2GsHA6O5sgvq0j2V3xnu", type: "pdf" }] },
    },
  },
};
    ...
    return (
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-12 text-center">
          ...
          <h1 className="font-display text-4xl font-bold text-gray-900">Lecture Notes</h1>
          <p className="mt-2 text-sm text-gray-500">Select your year to browse faculty-curated PDF notes by subject</p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="relative p-8 text-center">
                  ...
                  <p className="mt-1.5 text-xs text-gray-400">{Object.keys(CURRICULUM[year].semesters).length} Semesters</p>
    ...
    return (
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <motion.div variants={itemVariants} initial="hidden" animate="visible" className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">Choose a subject to browse its lecture notes</p>
        </motion.div>
        ...
        <motion.div variants={itemVariants} initial="hidden" animate="visible" className="mb-8">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500">{totalFiles} PDFs available across {units.length} units</p>
            </div>
          </div>
            ...
            {units.map(([unitKey, unit], idx) => {
              ...
              return (
                <motion.div key={unitKey} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 * idx }}
                  className="overflow-hidden rounded-2xl bg-white/80 backdrop-blur-glass border border-white/30 shadow-glass transition-all duration-300 hover:shadow-glass-lg"
                >
                  <button onClick={() => setExpandedUnit(isExpanded ? null : unitKey)}
                    className={`flex w-full items-center justify-between px-5 py-4 text-left transition-all ${isExpanded ? `${uc.light} border-b border-gray-100` : "hover:bg-white/90"}`}
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br ${uc.from} ${uc.to} text-white text-xs font-bold shadow-sm transition-transform duration-300 ${isExpanded ? 'scale-110' : ''}`}>
                        {unitKey}
                      </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {fileCount > 0 && (
                        <span className={`rounded-full ${uc.badge} px-3 py-0.5 text-[10px] font-bold`}>
                          {fileCount} PDF{fileCount > 1 ? "s" : ""}
                        </span>
                      )}
                      <FiChevronDown size={16} className={`text-gray-400 transition-transform duration-200 ${isExpanded ? "rotate-180" : ""}`} />
                    </div>
                  </button>
                    ...
                    {isExpanded && (
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.25 }} className="overflow-hidden">
                        <div className="px-5 py-4">
                          {unit.syllabus && (
                            <div className="mb-4 rounded-xl bg-gray-50/80 px-4 py-3 border border-gray-100">
                              <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Topics Covered</p>
                              <p className="text-[11px] text-gray-600 leading-relaxed">{unit.syllabus}</p>
                            </div>
                          )}
                            ...
                            <div className="space-y-2">
                              {unit.files.map((file, i) => (
                                <motion.button key={file.id} initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.05 }}
                                  ...
                                  className="group flex w-full items-center gap-3 rounded-xl border border-gray-100 bg-white p-3.5 text-left transition-all hover:border-blue-200 hover:bg-blue-50/50 hover:shadow-sm active:scale-[0.98]"
                                >
                                  <div className="flex h-11 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-red-50 to-rose-50 text-red-500 shadow-sm overflow-hidden">
                                    {file.type === "doc" ? (
                                  ...
                                  <div className="min-w-0 flex-1">
                                    <p className="text-sm font-semibold text-gray-900 truncate group-hover:text-blue-600 transition-colors">{file.title}</p>
                                    <p className="text-[10px] text-gray-400">
                                      {file.type === "doc" ? "Google Doc" : file.type === "docx" ? "Word" : file.type === "pptx" || file.type === "ppt" ? "PowerPoint" : "PDF"} · {unit.title}
                                    </p>
                                  </div>
                                  <div className="shrink-0 rounded-full bg-gray-100 p-2 text-gray-400 group-hover:bg-blue-100 group-hover:text-blue-600 transition-all">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
                <div className="min-w-0 flex-1">
                  <h3 className="truncate text-sm font-bold text-gray-900">{viewingPdf.title}</h3>
                  <p className="text-[11px] text-gray-500">{viewingPdf.subject} · {viewingPdf.unit}</p>
                </div>
                <div className="flex items-center gap-2">
                  <a href={getDriveDownloadUrl(viewingPdf.fileId, viewingPdf.type)} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-700 px-4 py-2 text-xs font-bold text-white shadow-soft transition-all duration-300 hover:shadow-premium hover:from-blue-500 hover:to-indigo-600"
                  >
              ...
              <div className="aspect-[4/3] w-full bg-gray-100 sm:aspect-[16/10] lg:aspect-[16/9]">
                <iframe src={getDrivePreviewUrl(viewingPdf.fileId, viewingPdf.type)} title={viewingPdf.title}
