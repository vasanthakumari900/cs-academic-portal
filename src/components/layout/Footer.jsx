...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-[#0A192F] via-[#0B2545] to-[#060D19] text-white font-sans border-t-4 border-[#D97706]">
      ...
      <div className="relative border-b border-white/10 bg-white/5 backdrop-blur-md py-4 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <div className="flex items-center gap-3">
            ...
            <span className="font-extrabold text-[#F59E0B] uppercase tracking-wider">
          ...
          <div className="flex flex-wrap items-center gap-4 text-white/90 font-bold">
            <a href="https://dgvc.in/lms/login.php" target="_blank" rel="noreferrer" className="flex items-center gap-1.5 bg-[#D97706] text-white px-3 py-1 rounded-lg hover:bg-[#B45309] transition-all font-black text-xs">
            ...
            <a href="https://www.dgvaishnavcollege.edu.in/" target="_blank" rel="noreferrer" className="flex items-center gap-1 text-xs hover:text-white transition-colors">
              <FiGlobe size={13} className="text-[#2DD4BF]" /> Official Website <FiExternalLink size={11} />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-white rounded-xl shadow-md border-2 border-[#D97706] shrink-0">
                <img
                  src={collegeLogo}
                  alt="DDGDVC College Logo"
            ...
            <div className="space-y-2.5 text-xs text-white/70">
              <div className="flex items-start gap-2.5">
                <FiMapPin size={16} className="text-[#2DD4BF] shrink-0 mt-0.5" />
              ...
              <div className="flex items-center gap-2.5">
                <FiMail size={15} className="text-[#F59E0B] shrink-0" />
                <a href="mailto:principal@dgvaishnavcollege.edu.in" className="hover:text-[#F59E0B] transition-colors">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              {[
                ...
                <a
                  ...
                  rel="noreferrer"
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-white/10 border border-white/15 text-white/80 transition-all duration-200 hover:bg-[#D97706] hover:text-white hover:border-[#D97706] hover:scale-110 shadow-xs"
                >
                  <Icon size={15} />
                </a>
              ))}
          ...
          {/* Col 3: Resources */}
          <div>
            <h4 className="mb-4 text-xs font-extrabold uppercase tracking-widest text-[#F59E0B] border-b border-[#F59E0B]/20 pb-2 inline-block font-mono">
              Academic Resources
            </h4>
            <ul className="space-y-2.5">
              {resourceLinks.map((item) => (
                <li key={item.label}>
                  ...
                  >
                    <item.icon size={13} className="text-[#2DD4BF] shrink-0" />
              ...
              {departmentLinks.map((item) => (
                <li key={item.label}>
                  <Link
                    ...
                    className="group flex items-center gap-2 text-xs sm:text-sm text-white/70 transition-all duration-200 hover:text-white hover:translate-x-1"
                  >
                    <FiChevronRight size={12} className="text-white/40 group-hover:text-[#F59E0B] transition-colors" />
                    <span>{item.label}</span>
                  </Link>
                </li>
              ))}
                ...
                <li key={item.label}>
                  {item.isExternal ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="group flex items-center gap-2 text-xs sm:text-sm text-white/70 transition-all duration-200 hover:text-[#2DD4BF] hover:translate-x-1"
                    >
                      <FiExternalLink size={12} className="text-[#2DD4BF] shrink-0" />
                      <span>{item.label}</span>
                    </a>
                  ) : (
                    <Link
        ...
        <div className="mt-12 pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-white font-semibold">
          ...
          <div className="flex items-center gap-2 text-xs text-white/90">
            ...
            <span className="text-[#F59E0B] font-black tracking-wider uppercase bg-white/10 px-2.5 py-1 rounded-md border border-amber-400/30 font-mono">
              CS Academic Portal
            </span>
          </div>
        </div>
