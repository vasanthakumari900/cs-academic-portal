      ...
      <div className="group relative flex flex-col gap-3 overflow-hidden rounded-xl bg-white border border-[#E5E7EB] shadow-sm transition-all duration-300 hover:shadow-sm text-left">
        <div className="relative p-5 flex flex-col gap-3">
          <div className="flex items-start gap-3">
            {/* PDF icon */}
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-[#021C4F]/10 text-[#021C4F] transition-transform">
              <FiFileText size={22} />
            </div>
            <div className="min-w-0 flex-1">
              <h3 className="truncate font-sans text-sm font-semibold text-[#021C4F] group-hover:text-[#C50337] transition-colors">
                {doc.title}
              </h3>
            ...
            <button
              ...
              className={`shrink-0 rounded-lg p-1.5 transition-all ${
                bookmarked
                  ? "text-[#021C4F] bg-[#021C4F]/10"
                  : "text-[#6B7280] hover:text-[#021C4F] hover:bg-[#021C4F]/10"
              }`}
          ...
          <div className="flex flex-wrap items-center gap-2">
            {doc.pages && (
              <span className="inline-flex items-center gap-1 rounded bg-[#021C4F]/10 px-2 py-0.5 text-[10px] font-semibold text-[#021C4F]">
            ...
            {doc.year && doc.regulation && (
              <span className="inline-flex items-center gap-1 rounded bg-[#C50337]/10 px-2 py-0.5 text-[10px] font-semibold text-[#021C4F]">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <button
              ...
              className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-[#021C4F] hover:bg-[#C50337] py-2.5 text-xs font-bold text-white shadow-sm transition-all active:scale-95"
            >
