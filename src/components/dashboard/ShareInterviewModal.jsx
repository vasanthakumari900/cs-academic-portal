  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
      <motion.div
        ...
        className="w-full max-w-xl rounded-2xl bg-white p-6 shadow-2xl space-y-4 max-h-[90vh] overflow-y-auto"
      >
        <div className="flex items-center justify-between border-b pb-3 border-slate-100">
          <div>
            <h2 className="text-lg font-bold text-[#021C4F]">Share Interview Experience</h2>
            <p className="text-xs text-slate-500">Help fellow CS students prepare for campus recruitment drives.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="block font-semibold text-slate-700 mb-1">Verdict</label>
              <select
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Interview Rounds Breakdown</label>
            <textarea
              rows={3}
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Specific Questions Asked</label>
            <textarea
              rows={3}
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Preparation Tips & Advice</label>
            <textarea
              rows={2}
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
            ...
            <Button type="submit" disabled={loading}>{loading ? "Submitting..." : "Publish Experience"}</Button>
          </div>
        </form>
      </motion.div>
    </div>
