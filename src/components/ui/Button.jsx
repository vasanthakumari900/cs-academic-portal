...
const variants = {
  ...
  ghost: "bg-transparent text-[#4B5563] hover:bg-slate-150 hover:text-[#0F4C81]",
  outline: "border border-[#E5E7EB] bg-white text-[#4B5563] hover:bg-[#F8FAFC] hover:text-[#0F4C81]",
